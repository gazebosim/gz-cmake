...
macro(ign_setup_packages)
  ...
  set(IGN_DATAROOT_INSTALL_DIR      ${CMAKE_INSTALL_DATAROOTDIR})
  set(IGN_SHARE_INSTALL_DIR_POSTFIX "ignition/${PROJECT_NAME_LOWER}")
  set(IGN_SHARE_INSTALL_DIR         "${IGN_DATAROOT_INSTALL_DIR}/${IGN_SHARE_INSTALL_DIR_POSTFIX}")
