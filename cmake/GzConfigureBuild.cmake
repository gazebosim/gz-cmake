...
macro(gz_configure_build)
  ...
  if(build_errors)
    set(all_errors "-- BUILD ERRORS: These must be resolved before compiling.")
    foreach(msg ${build_errors})
      gz_string_append(all_errors "-- ${msg}" DELIM "\n")
    endforeach()
    gz_string_append(all_errors "-- END BUILD ERRORS" DELIM "\n")

    set(error_str "Errors encountered in build. Please see BUILD ERRORS above.")
    gz_string_append(all_errors "${error_str}" DELIM "\n")

    if(gz_configure_build_QUIT_IF_BUILD_ERRORS)
      message(FATAL_ERROR "${all_errors}")
    else()
      message(SEND_ERROR "${all_errors}")
    endif()
