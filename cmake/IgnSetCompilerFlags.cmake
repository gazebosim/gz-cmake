...
macro(ign_setup_msvc)
  ...
  set(IGN_RUNTIME_LIBRARY "/MDd" CACHE STRING "Visual Studio Runtime Library Flag (strongly recommend /MDd or /MD)")
  set_property(CACHE IGN_RUNTIME_LIBRARY PROPERTY STRINGS /MDd /MD /MT /MTd)
  ...
  if(USE_IGN_RECOMMENDED_FLAGS)
    ...
    set(CMAKE_C_FLAGS_DEBUG "${CMAKE_C_FLAGS_DEBUG} ${IGN_RUNTIME_LIBRARY} ${MSVC_DEBUG_FLAGS}")
    set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} ${IGN_RUNTIME_LIBRARY} ${MSVC_DEBUG_FLAGS}")
    ...
    set(CMAKE_C_FLAGS_RELWITHDEBINFO "${CMAKE_C_FLAGS_RELWITHDEBINFO} ${IGN_RUNTIME_LIBRARY} ${MSVC_RELWITHDEBINFO_FLAGS}")
    set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "${CMAKE_CXX_FLAGS_RELWITHDEBINFO} ${IGN_RUNTIME_LIBRARY} ${MSVC_RELWITHDEBINFO_FLAGS}")
